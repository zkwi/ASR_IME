...
- Floating captions: real-time transcription feedback near the bottom of the screen. One-line text stays on one line; wrapped or newline-delimited text prefers up to two visible lines when height allows. Captions show text, processing state, and errors only.
